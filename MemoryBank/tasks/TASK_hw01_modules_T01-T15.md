...
**битые HTTP со статус-кодами** · 🔧 р6 (Alex): `401/403/429` — отдельная секция «вероятно защита от ботов» · `TIMEOUT` отдельно · файлы с ошибками.
...
| Что | Путь |
|---|---|
| Скил сборки hw01 | **`.claude/skills/hw01_dev_test-build/SKILL.md`** |
| Вызов | `/hw01_dev_test-build` либо «собери hw01», «запусти агентов по hw01» |
