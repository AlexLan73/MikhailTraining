        ...
        SectionSpec(
            ...
            fields=(
                ...
                FieldSpec(
                    ...
                    (
                        "сколько .md-ФАЙЛОВ разбирается одновременно (10 — решение Alex, ревью 6:",
                        "с HTTP 10 потоков дают ×10, без HTTP цена +8 %; разбор под GIL не масштабируется).",
                        "Поднимать: много внешних ссылок, медленные сайты.",
                        "Снижать:   слабый CPU.",
                    ),
                ),
            ),
